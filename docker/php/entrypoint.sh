...
#   2. Generar APP_KEY solo si está vacía.
#   3. Instalar dependencias si vendor/ no está disponible (ocurre cuando el
#      proyecto se monta como volumen y tapa el vendor/ de la imagen).
